...
const FurniturePage = () => {
  ...
  const filteredProducts = selectedSubcategory 
    ? furnitureProducts.filter(product => product.subcategory === selectedSubcategory)
    : furnitureProducts;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              {furnitureCategory?.subcategories.map((subcategory) => (
                <button
          ...
          {selectedSubcategory && (
            <div className="mb-12">
              ...
              <p className="text-gray-600 font-light">
                {furnitureCategory?.subcategories.find(sub => sub.name === selectedSubcategory)?.description}
              </p>
            </div>
          )}
