...
const AccessoriesPage = () => {
  ...
  const filteredProducts = selectedSubcategory 
    ? accessoriesProducts.filter(product => product.subcategory === selectedSubcategory)
    : accessoriesProducts;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              {accessoriesCategory?.subcategories.map((subcategory) => (
                <button
          ...
          {selectedSubcategory && (
            <div className="mb-12">
              ...
              <p className="text-gray-600 font-light">
                {accessoriesCategory?.subcategories.find(sub => sub.name === selectedSubcategory)?.description}
              </p>
            </div>
          )}
